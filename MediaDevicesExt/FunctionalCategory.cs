...
namespace MediaDevices
{
    ...
    public enum FunctionalCategory
    {
        ...
        /// </summary>
        [Guid(0x08EA466B, 0xE3A4, 0x4336, 0xA1, 0xF3, 0xA4, 0x4D, 0x2B, 0x5C, 0x43, 0x8C)]
        Device,
        ...
        /// </summary>
        [Guid(0x23F05BBC, 0x15DE, 0x4C2A, 0xA5, 0x5B, 0xA9, 0xAF, 0x5C, 0xE4, 0x12, 0xEF)]
        Storage,
        ...
        /// </summary>            
        [Guid(0x613CA327, 0xAB93, 0x4900, 0xB4, 0xFA, 0x89, 0x5B, 0xB5, 0x87, 0x4B, 0x79)]
        StillImageCapture,
        ...
        /// </summary>               
        [Guid(0x3F2A1919, 0xC7C2, 0x4A00, 0x85, 0x5D, 0xF5, 0x7C, 0xF0, 0x6D, 0xEB, 0xBB)]
        AudioCapture,
        ...
        /// </summary>                      
        [Guid(0xE23E5F6B, 0x7243, 0x43AA, 0x8D, 0xF1, 0x0E, 0xB3, 0xD9, 0x68, 0xA9, 0x18)]
        VideoCapture,
        ...
        /// </summary>                     
        [Guid(0x0044A0B1, 0xC1E9, 0x4AFD, 0xB3, 0x58, 0xA6, 0x2C, 0x61, 0x17, 0xC9, 0xCF)]
        SMS,

        /// <summary>
        /// Indicates this object provides information about the rendering characteristics of the device. 
        /// </summary>                            
        [Guid(0x08600BA4, 0xA7BA, 0x4A01, 0xAB, 0x0E, 0x00, 0x65, 0xD0, 0xA3, 0x56, 0xD3)]
        ...
        /// </summary>                 
        [Guid(0x48F4DB72, 0x7C6A, 0x4AB0, 0x9E, 0x1A, 0x47, 0x0E, 0x3C, 0xDB, 0xF2, 0x6A)]
